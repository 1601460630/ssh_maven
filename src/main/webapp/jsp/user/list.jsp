...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="UserAction_findByName" method=post>
											...
											<TBODY>
												...
												<s:iterator value="#list" var="user">
													<TR
														...
														<TD><s:a action="UserAction_findByCode">
																<s:param name="user_code" value="user_code"></s:param>
														    	编辑
														    </s:a> <s:a action="UserAction_delete">
																<s:param name="user_code" value="user_code"></s:param>
														    	删除
														    </s:a></TD>
													</TR>
