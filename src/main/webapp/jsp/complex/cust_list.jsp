...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="ComplexAction_findCust?test=test" method=post>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="name"
											...
											<TBODY>
												...
												<s:iterator value="#list" var="cust">
													<TR
														...
														<TD><s:property value="#cust.cust_industry" /></TD>
														<TD><s:property value="#cust.cust_linkman" /></TD>
														<TD><s:property value="#cust.cust_linkman_mobile" /></TD>
														<TD><s:property value="#cust.cust_phone" /></TD>
														<TD><s:property value="#cust.cust_level" /></TD>
														<TD><s:a action="CustomerAction_findById">
																<s:param name="id" value="cust_id"></s:param> 编辑
														    </s:a> 
														    <s:a action="CustomerAction_delete">
																<s:param name="id" value="cust_id"></s:param> 删除
														    </s:a></TD>
													</TR>
												</s:iterator>
