...
public class Customer {
	 ...
	 * CREATE TABLE `cst_customer` (
	  `cust_id` BIGINT(32) NOT NULL AUTO_INCREMENT COMMENT '客户编号(主键)',1
	  `cust_name` VARCHAR(32) NOT NULL COMMENT '客户名称(公司名称)',1
	  `cust_industry` VARCHAR(32) DEFAULT NULL COMMENT '客户所属行业',
	  `cust_level` VARCHAR(32) DEFAULT NULL COMMENT '客户级别',1
	  `cust_linkman` VARCHAR(64) DEFAULT NULL COMMENT '联系人',1
	  `cust_linkman_mobile` VARCHAR(32) DEFAULT NULL COMMENT '联系人电话',1
	  `cust_phone` VARCHAR(64) DEFAULT NULL COMMENT '固定电话',1
	  `cust_mobile` VARCHAR(16) DEFAULT NULL COMMENT '移动电话',1
	  PRIMARY KEY (`cust_id`)
